...
- **Photo recognition** — take a photo, crop to your hand row, and tiles are identified using Claude's vision API
...
- [Anthropic SDK](https://github.com/anthropics/anthropic-sdk-typescript) — `claude-opus-5` for tile recognition
